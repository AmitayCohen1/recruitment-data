    ...
    >
      <body className="min-h-full bg-black">
        <LocaleProvider locale={lang}>
          <SectionTracker />
          {/* vaul scales this wrapper back while a mobile Drawer is open, revealing
              the black body behind — the native "card slides up over the page" depth. */}
          <div data-vaul-drawer-wrapper="" className="min-h-full bg-background">
