...
export function Subgroups() {
  ...
  return (
    <Panel>
      <PanelHeader
        title="צלילה לתוך המגזרים"
        subtitle={`לא כל מגזר אחיד — אחוז ${label} לפי תת-קבוצה (גאוגרפיה/זרם), ${gender}, ${SLATEST}`}
      >
      ...
      <p className="pt-4 text-xs text-muted-foreground">
        המספר האפור = מספר בתי הספר בתת-הקבוצה · רוחב יחסי למוביל.
      </p>
    </Panel>
  );
}
